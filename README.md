...
## Sample Use Case
In this case, the user asks about chlordane. The model will follow the above flow to deduce the best dataset to search.
...
The model returns 10 candidate ingredients. Then will generate a response to the original query.
